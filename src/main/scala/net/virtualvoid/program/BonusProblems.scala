...
object BonusProblems {
  ...
  lazy val problemBonusHard = Seq(TrainingProblem("(lambda (x_9) (if0 (and (shr16 (plus (not (if0 (and 1 (shr4 x_9)) (not 0) 0)) 0)) 1) (shl1 (plus (shr16 (if0 (xor (xor (shl1 x_9) x_9) 1) 1 x_9)) 1)) (shr4 (shl1 (plus (if0 (and (xor (shr4 x_9) 0) x_9) 1 x_9) x_9)))))", "2gl5AOS4fgP4bznOh8LBAgfE", 42, Seq("bonus", "and", "if0", "not", "plus", "shl1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_3) (if0 (and (not (plus (plus (if0 (and 1 x_3) (or 1 x_3) 0) x_3) x_3)) 1) (if0 (and x_3 1) (shr4 (not (shl1 x_3))) (or 0 0)) (shr16 (shr4 (shr1 (plus (if0 (shr16 (shr4 (not x_3))) (shl1 1) x_3) 1))))))", "AlZMIyBOmMTr9fZTH6uHuJJD", 41, Seq("bonus", "and", "if0", "not", "or", "plus", "shl1", "shr1", "shr16", "shr4")),
    TrainingProblem("(lambda (x_11) (if0 (and (shr16 (if0 (shr4 (or (plus (shr16 (shl1 (shr4 x_11))) 1) 1)) 0 x_11)) 1) (shr1 (shr4 (not (if0 (xor (shr16 (not (or x_11 0))) 1) 0 x_11)))) (xor (not (not (if0 (xor (plus (shr16 x_11) x_11) 0) x_11 1))) x_11)))", "Fjh0PkihmrtoeMNuINWqaA09", 43, Seq("bonus", "and", "if0", "not", "or", "plus", "shl1", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_2) (if0 (and (shr4 (shr16 (not (shr4 (if0 (plus (xor (shr16 0) 1) x_2) 0 x_2))))) 1) (not (shl1 (and (if0 (plus (shr16 (or 1 0)) x_2) 1 x_2) 1))) (or (or (shl1 (shl1 (if0 x_2 1 x_2))) 1) 0)))", "mqBIzAyWUKQxwoi4SAeGHFvN", 40, Seq("bonus", "and", "if0", "not", "or", "plus", "shl1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_17) (if0 (and (shr16 (if0 (xor (plus (not (not 0)) 1) (not x_17)) (shr1 x_17) x_17)) 1) (plus (or (if0 (plus (shr16 (shr1 (shr1 x_17))) 0) 0 x_17) 1) x_17) (not (plus (shr4 (if0 (or (and 1 0) (not x_17)) x_17 1)) x_17))))", "yYCz500BwFYT5cJUvlQwUu25", 43, Seq("bonus", "and", "if0", "not", "or", "plus", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_17) (if0 (and (shr16 (plus (not (if0 (xor (and x_17 (shr1 x_17)) 0) x_17 0)) x_17)) 1) (xor (not (plus (if0 (and x_17 (shr4 (shr16 x_17))) 1 x_17) x_17)) x_17) (shl1 (plus (and (if0 (shr4 (or (shl1 x_17) x_17)) x_17 1) x_17) 0))))", "3nTzudbfF3wfWhj3ddcv7Fz1", 43, Seq("bonus", "and", "if0", "not", "or", "plus", "shl1", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_7) (if0 (and (xor 1 (shr1 (plus (if0 (plus (shr1 (shl1 1)) x_7) 0 x_7) 0))) 1) (shr16 (shr16 (plus (if0 (xor (or (shl1 x_7) x_7) x_7) 1 x_7) x_7))) (shr16 (shr16 (shr4 (shr1 (if0 (xor (shr1 (plus x_7 x_7)) 1) 1 x_7)))))))", "DZlGcT21qpjTHveB1BIaQo68", 43, Seq("bonus", "and", "if0", "or", "plus", "shl1", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_4) (if0 (and (xor (shr4 (shr16 (if0 (plus (xor (shr4 x_4) 1) x_4) 0 x_4))) x_4) 1) (not (xor (shl1 (if0 (and (shl1 (not 0)) (shr1 x_4)) 0 x_4)) 0)) (xor (if0 (shr1 x_4) (shr1 1) x_4) (shl1 1))))", "21FaevNHgGldcgGHBY72BtJp", 39, Seq("bonus", "and", "if0", "not", "plus", "shl1", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_12) (if0 (and (shr16 (not (plus (if0 (plus (or x_12 x_12) 1) x_12 (shl1 1)) x_12))) 1) (shr4 (shr1 (shr16 (and (if0 (plus 1 x_12) 1 (shr4 (shr4 x_12))) x_12)))) (shr16 (xor (shr1 (if0 (and (plus (shr16 1) x_12) 1) x_12 0)) x_12))))", "H3EOno9Iik7GrrRFfCDFAKNl", 43, Seq("bonus", "and", "if0", "not", "or", "plus", "shl1", "shr1", "shr16", "shr4", "xor")),
    TrainingProblem("(lambda (x_4) (if0 (and (xor (shr4 (shr16 (if0 (plus (xor (shr4 x_4) 1) x_4) 0 x_4))) x_4) 1) (not (xor (shl1 (if0 (and (shl1 (not 0)) (shr1 x_4)) 0 x_4)) 0)) (xor (if0 (shr1 x_4) (shr1 1) x_4) (shl1 1))))", "lYn76dGwG4xgVndbTWWHVIqG", 39, Seq("bonus", "and", "if0", "not", "plus", "shl1", "shr1", "shr16", "shr4", "xor")))
